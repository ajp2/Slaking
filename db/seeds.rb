...
# Channels
simpsons = Channel.create(name: "The Simpsons", description: "A topic related to The Simpsonse", owner_id: admin.id)
...
homer.avatar.attach(
  io: File.open(File.join(Rails.root, "app/assets/images/avatars/homer.png")),
  filename: "homer.png"
)
...
bart.avatar.attach(
  io: File.open(File.join(Rails.root, "app/assets/images/avatars/bart.jpeg")),
  filename: "bart.jpeg"
)
lisa = User.create(username: "Lisa Simpson", password: "password123")
lisa.avatar.attach(
  io: File.open(File.join(Rails.root, "app/assets/images/avatars/lisa.png")),
  filename: "lisa.png"
)

yoda = User.create(username: "Yoda", password: "password123")
yoda.avatar.attach(
  io: File.open(File.join(Rails.root, "app/assets/images/avatars/yoda.png")),
  filename: "yoda.png"
)
